...
// Catatan: Adapter ini memiliki fungsionalitas yang sama dengan BestSellerAdapter.
// Di masa mendatang, Anda bisa mempertimbangkan untuk membuat satu adapter generik.
public class DeliveredDailyAdapter extends RecyclerView.Adapter<DeliveredDailyAdapter.ProductViewHolder> {

    private Context context;
    private List<Produk> productList;

    public DeliveredDailyAdapter(Context context, List<Produk> productList) {
